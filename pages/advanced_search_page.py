...
class AdvancedSearchPage(BasePage):
    ...
    def check_selecting_the_rule_empty_or_not_empty(self):
        ...
        self.elements_are_visible(self.locators.LI_MENU_ITEM)[0].click()
        self.action_triple_click(self.element_is_visible(self.locators.RUL_FIELD))
    ...
    def check_editing_search(self, name):
        ...
        self.action_triple_click(self.element_is_visible(self.locators.CRITERION_FIELD))
    ...
    def check_cancel_saving(self):
        ...
        self.action_triple_click(self.element_is_visible(self.locators.SEARCH_NAME_FIELD))

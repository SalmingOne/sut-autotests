...
class UserPage(BasePage):
    ...
    @testit.step("Проверяем, что нельзя поставить дату увольнения в дату принятия на работу и можно поставить на следующий день")
    @allure.step("Проверяем, что нельзя поставить дату увольнения в дату принятия на работу и можно поставить на следующий день")

...
class PivotTabPage(BasePage):
    ...
    @allure.title("Переходим на сводную таблицу через меню")
    ...
    @allure.title("Берем id строки нужного проекта для дальнейшего поиска ")
    ...
    @allure.title("Берем сумму списаных часов за период по проекту")
    ...
    @allure.title("Берем сумму списаных часов за период по пользователю")
    ...
    @allure.title("Переходим на отображение таблицы по пользователю")
    ...
    @allure.title("Открываем списо проектов пользователя")

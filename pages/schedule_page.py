...
class SchedulePage(BasePage):
    ...
    def editing_a_specific_day(self, start_work, start_break):
        self.action_triple_click(self.element_is_visible(self.locators.START_WORK))
        ...
        self.action_triple_click(self.element_is_visible(self.locators.START_BREAK))
    ...
    def change_second_break(self):
        self.elements_are_visible(self.locators.START_BREAK)[1].click()
        self.elements_are_visible(self.locators.START_BREAK)[1].send_keys('14:00')
        self.element_is_visible(self.locators.LI_MENU_ITEM).click()
        self.elements_are_visible(self.locators.END_BREAK)[1].click()
        self.elements_are_visible(self.locators.END_BREAK)[1].send_keys('15:00')
        self.element_is_visible(self.locators.LI_MENU_ITEM).click()
        self.elements_are_visible(self.locators.DURATION_FIELDS)[0].click()
    ...
    def return_before_values(self):
        ...
        self.element_is_visible(self.locators.DELETE_BREAK_BUTTON).click()
        self.action_double_click(self.elements_are_visible(self.locators.DURATION_FIELDS)[0])
        self.elements_are_visible(self.locators.DURATION_FIELDS)[0].send_keys('8ч')
        self.element_is_visible(self.locators.LI_MENU_ITEM).click()
    ...
    def change_end_work_time(self):
        self.action_double_click(self.element_is_visible(self.locators.END_WORK))
    ...
    def add_break_before_working_day(self):
        ...
        self.element_is_visible(self.locators.LI_MENU_ITEM).click()
        self.action_triple_click(self.element_is_visible(self.locators.END_BREAK))
    ...
    def check_add_break_in_start_work_time(self):
        ...
        self.element_is_visible(self.locators.LI_MENU_ITEM).click()
        self.action_triple_click(self.element_is_visible(self.locators.END_BREAK))
        self.element_is_visible(self.locators.END_BREAK).send_keys('10:00')
        self.element_is_visible(self.locators.LI_MENU_ITEM).click()
        self.action_triple_click(self.elements_are_visible(self.locators.DURATION_FIELDS)[0])
        self.elements_are_visible(self.locators.DURATION_FIELDS)[0].send_keys('8ч')
        self.element_is_visible(self.locators.LI_MENU_ITEM).click()
        self.action_move_to_element(self.element_is_visible(self.locators.DRAWER_SUBMIT_BUTTON))
        assert not self.element_is_clickable(self.locators.DRAWER_SUBMIT_BUTTON, 1)
    ...
    def check_add_break_for_hour_before_end_work_time(self):
        ...
        self.element_is_visible(self.locators.LI_MENU_ITEM).click()
        self.action_triple_click(self.element_is_visible(self.locators.END_BREAK))
        self.element_is_visible(self.locators.END_BREAK).send_keys('18:00')
        self.element_is_visible(self.locators.LI_MENU_ITEM).click()
        self.action_triple_click(self.elements_are_visible(self.locators.DURATION_FIELDS)[0])
        self.elements_are_visible(self.locators.DURATION_FIELDS)[0].send_keys('8ч')
        self.element_is_visible(self.locators.LI_MENU_ITEM).click()

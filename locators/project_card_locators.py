...
class ProjectCardLocators:
    ...
    CHANGE_RADIOGROUP_PERCENT = (By.XPATH, '//span[contains(text(), "Проценты")]/..')
    CHANGE_RADIOGROUP_HOUR = (By.XPATH, '//span[contains(text(), "Часы")]/..')
    ...
    CELLS = (By.XPATH, '//*[contains(@col-id,"resultHours") and contains(@class,"ag-cell-value")]')
    ...
    PROGRESS_TAB = (By.XPATH, '//div[text()="Ход выполнения"]')
